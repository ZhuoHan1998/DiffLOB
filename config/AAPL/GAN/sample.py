class Configuration:
    def __init__(self):
        ...
        self.gan_samples_saving_path = "samples/AAPL/cgan/cgan.npy"
        ...
        self.trend_cond_path = "conds/AAPL/trend_test.npy"
        self.volatility_cond_path = "conds/AAPL/volatility_test.npy"
        self.liquidity_cond_path = "conds/AAPL/liquidity_test.npy"
        self.imb_cond_path = "conds/AAPL/imb_test.npy"
        
        self.gan_model_saving_path = "models/AAPL/cgan_wgangp.pth"
