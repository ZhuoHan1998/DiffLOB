class Configuration:
    ...
    def __init__(self):
        ...
        self.diff_model = 's4'  # ['s4', 'csdi', 'wavenet', 'wavenet_motion', 'wavenet_control', 'wavenet_motion_control']
        self.diff_model_saving_path = 'models/AAPL/diff_s4_AAPL_AR.pth' # model_architecture_sde_stockname.pth
        ...
        self.samples_saving_path = 'samples/AAPL/s4/AR_high_volatility.npy' # model_architecture_sde_stockname.pth
