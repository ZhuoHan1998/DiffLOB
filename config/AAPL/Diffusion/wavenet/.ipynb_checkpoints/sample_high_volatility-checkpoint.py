class Configuration:
    ...
    def __init__(self):
        ...
        self.diff_model_saving_path = 'models/AAPL/diff_wavenet_vpsde_FTF_AAPL_AR.pth' # model_architecture_sde_stockname.pth
        ...
        self.samples_saving_path = 'samples/AAPL/wavenet/vpsde_FTF_AR_high_volatility.npy' # model_architecture_sde_stockname.pth
