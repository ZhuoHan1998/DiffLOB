class Configuration:
    ...
    def __init__(self):
        ...
        self.diff_model_saving_path = 'models/AAPL/diff_csdi_AAPL_AR.pth' # model_architecture_sde_stockname.pth
        ...
        self.samples_saving_path = 'samples/AAPL/csdi/AR_high_volatility.npy' # model_architecture_sde_stockname.pth
