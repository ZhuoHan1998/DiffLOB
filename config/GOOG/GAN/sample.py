class Configuration:
    def __init__(self):
        ...
        self.gan_samples_saving_path = "samples/GOOG/cgan/cgan.npy"
        ...
        self.trend_cond_path = "conds/GOOG/trend_test.npy"
        self.volatility_cond_path = "conds/GOOG/volatility_test.npy"
        self.liquidity_cond_path = "conds/GOOG/liquidity_test.npy"
        self.imb_cond_path = "conds/GOOG/imb_test.npy"
