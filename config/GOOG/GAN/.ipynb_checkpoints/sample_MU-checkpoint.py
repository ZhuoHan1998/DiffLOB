class Configuration:
    def __init__(self):
        ...
        self.gan_samples_saving_path = "samples/MU/cgan/cgan.npy"
        ...
        self.trend_cond_path = "conds/MU/trend_test.npy"
        self.volatility_cond_path = "conds/MU/volatility_test.npy"
        self.liquidity_cond_path = "conds/MU/liquidity_test.npy"
        self.imb_cond_path = "conds/MU/imb_test.npy"
        
        self.gan_model_saving_path = "models/MU/cgan_wgangp.pth"
