class Configuration:
    ...
    def __init__(self):
        ...
        self.diff_model_saving_path = 'models/MU/diff_s4_MU_AR.pth' # model_architecture_sde_stockname.pth
        ...
        self.samples_saving_path = 'samples/MU/s4/AR_high_volatility.npy' # model_architecture_sde_stockname.pth
