class Configuration:
    ...
    def __init__(self):
        ...
        self.diff_model_saving_path = 'models/GOOG/diff_wavenet_vpsde_FTF_GOOG_AR_control.pth' # model_architecture_sde_stockname.pth
        ...
        self.samples_saving_path = 'samples/GOOG/wavenet_control/vpsde_FTF_AR_high_volatility.npy' # model_architecture_sde_stockname.pth
