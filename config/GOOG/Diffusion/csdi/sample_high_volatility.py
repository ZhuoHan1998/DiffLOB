class Configuration:
    ...
    def __init__(self):
        ...
        self.diff_model_saving_path = 'models/GOOG/diff_csdi_GOOG_AR.pth' # model_architecture_sde_stockname.pth
        ...
        self.samples_saving_path = 'samples/GOOG/csdi/AR_high_volatility.npy' # model_architecture_sde_stockname.pth
