class Configuration:
    ...
    def __init__(self):
        ...
        self.diff_model_saving_path = 'models/MU/diff_csdi_MU_AR.pth' # model_architecture_sde_stockname.pth
        ...
        self.samples_saving_path = 'samples/MU/csdi/AR_high_volatility.npy' # model_architecture_sde_stockname.pth
