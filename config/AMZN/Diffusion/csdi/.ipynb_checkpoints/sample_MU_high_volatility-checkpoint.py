class Configuration:
    ...
    def __init__(self):
        ...
        self.diff_model = 'csdi'  # ['s4', 'csdi', 'wavenet', 'wavenet_motion', 'wavenet_control', 'wavenet_motion_control']
        self.diff_model_saving_path = 'models/AMZN/diff_csdi_AMZN_AR.pth' # model_architecture_sde_stockname.pth
        ...
        self.responsive_volatility = 'high' # ['high', 'low', None]
        ...
        self.samples_saving_path = 'samples/AMZN/csdi/AR_high_volatility.npy' # model_architecture_sde_stockname.pth
