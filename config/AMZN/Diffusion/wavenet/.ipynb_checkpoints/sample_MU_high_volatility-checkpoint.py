class Configuration:
    ...
    def __init__(self):
        ...
        self.diff_model_saving_path = 'models/AMZN/diff_wavenet_vpsde_FTF_AMZN_AR.pth' # model_architecture_sde_stockname.pth
        ...
        self.samples_saving_path = 'samples/AMZN/wavenet/vpsde_FTF_AR_high_volatility.npy' # model_architecture_sde_stockname.pth
