class Configuration:
    def __init__(self):
        ...
        self.gan_samples_saving_path = "samples/AMZN/cgan/cgan.npy"
        ...
        self.trend_cond_path = "conds/AMZN/trend_test.npy"
        self.volatility_cond_path = "conds/AMZN/volatility_test.npy"
        self.liquidity_cond_path = "conds/AMZN/liquidity_test.npy"
        self.imb_cond_path = "conds/AMZN/imb_test.npy"
        
        self.gan_model_saving_path = "models/AMZN/cgan_wgangp.pth"
